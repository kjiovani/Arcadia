...
if (!$id || !$game_id){ flash('error','Data tidak lengkap.'); header("Location: game.php?id=$game_id#komentar"); exit; }
...
if (!$isAdmin && (int)$row['user_id'] !== $uid){
  flash('error','Tidak diizinkan menghapus komentar ini.'); header("Location: game.php?id=$game_id#komentar"); exit;
}
