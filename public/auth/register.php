    ...
    <form method="post" action="">
      ...
      <div class="reg-grid">
        <div class="input-group">
          ...
          <input class="input" type="text" id="name" name="name" placeholder="Nama tampilan" required
            value="<?= e($_POST['name'] ?? '') ?>">
        </div>
        ...
        <div class="input-group full">
          ...
          <div class="pw-field">
            <input class="input" type="password" id="password" name="password" placeholder="Minimal 8 karakter"
              required>
          ...
          <div class="hint">Gunakan kombinasi <strong>huruf besar</strong>, <strong>angka</strong>, dan
            <strong>simbol</strong> untuk password yang kuat.
          </div>
        </div>
      ...
      <div class="reg-actions hint">
        Sudah punya akun?
        <a href="/arcadia/public/auth/login.php<?= $next ? ('?next=' . urlencode($next)) : '' ?>"
          style="color:inherit;text-decoration:underline">Masuk</a>
      </div>
    </form>
  </div>
</div>
