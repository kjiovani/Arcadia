...
<style>
  .yt-wrap{
    ...
    background:#0f0f16;margin:.65rem 0 1rem;
  }
  .yt-wrap iframe{position:absolute;inset:0;width:100%;height:100%;border:0}
  .ch-img{margin:.65rem 0 1rem}
  .ch-img img{width:100%;height:auto;display:block;border-radius:14px;border:1px solid rgba(255,255,255,.08)}
  .chap{margin:.5rem 0}
</style>
    ...
    <?php foreach ($chapters as $c): ?>
      <div class="card chap">
        ...
        <?php if ($yt): ?>
          <div class="yt-wrap">
            <iframe
              src="https://www.youtube-nocookie.com/embed/<?= e($yt) ?>?rel=0&modestbranding=1"
              title="YouTube video"
              loading="lazy"
