...
if (!defined('BASE_URL'))    define('BASE_URL', '/arcadia/public');
...
if (!defined('COVERS_PATH'))  define('COVERS_PATH', UPLOADS_PATH . '/covers');
if (!is_dir(COVERS_PATH)) @mkdir(COVERS_PATH, 0775, true);
